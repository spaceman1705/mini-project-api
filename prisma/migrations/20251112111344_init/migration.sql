...
-- CreateEnum
CREATE TYPE "EventStatus" AS ENUM ('DRAFT', 'PUBLISHED', 'CANCEL', 'FINISHED');
...
-- AddForeignKey
ALTER TABLE "RegisterToken" ADD CONSTRAINT "RegisterToken_userId_fkey" FOREIGN KEY ("userId") REFERENCES "users"("id") ON DELETE SET NULL ON UPDATE CASCADE;
